...
namespace Sorting
{
    public class BenchmarkWeek9_2
    {
        public static void RunBenchmark()
        {
            BenchmarkRunner.Run<MyBenchmark_4>();
        }
    }

    [MemoryDiagnoser]
    public class MyBenchmark_4
    {
        ...
        public MergeSortList<int> msList = new MergeSortList<int>();
        ...
        [Benchmark]
        public void MergeSort() => msList.Sort();
    }
}
